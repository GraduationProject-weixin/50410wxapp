...
# 50410wxapp基于+mysql的经济新闻资讯的设计与实现小程序(1)
...
第四点：可以降低信息管理成本；
## 1.3 研究内容
对经济新闻资讯设计制作，不仅需要技术支撑，也需要大量的理论研究。本文在对经济新闻资讯进行介绍时，将按照如下内容进行。

第一部分：介绍经济新闻资讯研究的背景意义，便于用户了解系统；

第二部分：介绍开发经济新闻资讯需要搭建的环境，包括技术和工具；

第三部分：介绍用户对经济新闻资讯的功能要求，以及对经济新闻资讯的性能要求等；
...
# 第2章 开发环境与技术
经济新闻资讯的编码实现需要搭建一定的环境和使用相应的技术，接下来的内容就是对经济新闻资讯用到的技术和工具进行介绍。
## 2.1 MYSQL数据库
...
### 3.1.2 经济可行性
本系统开发期间需要配置的软件环境，可以免费通过开发类官网下载安装，需要配置的硬件设备也不需要具备很高的性能，通常网吧电脑，或学校计算机机房的电脑都符合要求。因此，从经济方面考虑，经济新闻资讯开发可行。
### 3.1.3 操作可行性
经济新闻资讯根据用户使用习惯进行开发，设计的界面具有统一性，并具备优秀的导航功能。所以，只要会简单操作电脑的人员，可以无压力操作经济新闻资讯。
...
![C:/Users/Administrator/Desktop/temp111\1\\_\_\_\_img\短视频收藏.jpg](/md/blog.008.jpeg "C:/Users/Administrator/Desktop/temp111\1\\_\_\_\_img\短视频收藏.jpg")
短视频收藏实体属性图
...
![C:/Users/Administrator/Desktop/temp111\1\\_\_\_\_img\短视频信息.jpg](/md/blog.010.jpeg "C:/Users/Administrator/Desktop/temp111\1\\_\_\_\_img\短视频信息.jpg")
短视频信息实体属性图

（6）下图是新闻留言实体和其具备的属性。

![C:/Users/Administrator/Desktop/temp111\1\\_\_\_\_img\新闻留言.jpg](/md/blog.011.jpeg "C:/Users/Administrator/Desktop/temp111\1\\_\_\_\_img\新闻留言.jpg")
新闻留言实体属性图

（7）下图是短视频留言实体和其具备的属性。

![C:/Users/Administrator/Desktop/temp111\1\\_\_\_\_img\短视频留言.jpg](/md/blog.012.jpeg "C:/Users/Administrator/Desktop/temp111\1\\_\_\_\_img\短视频留言.jpg")
短视频留言实体属性图

（8）下图是新闻收藏实体和其具备的属性。

![C:/Users/Administrator/Desktop/temp111\1\\_\_\_\_img\新闻收藏.jpg](/md/blog.013.jpeg "C:/Users/Administrator/Desktop/temp111\1\\_\_\_\_img\新闻收藏.jpg")
新闻收藏实体属性图

（9）下图是新闻信息实体和其具备的属性。

![C:/Users/Administrator/Desktop/temp111\1\\_\_\_\_img\新闻信息.jpg](/md/blog.014.jpeg "C:/Users/Administrator/Desktop/temp111\1\\_\_\_\_img\新闻信息.jpg")
新闻信息实体属性图
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|duanshipin\_name|String|短视频名称|是|
|3|duanshipin\_photo|String|短视频照片|是|
|4|duanshipin\_video|String|短视频视频|是|
|5|zan\_number|Integer|赞|是|
|6|cai\_number|Integer|踩|是|
|7|duanshipin\_types|Integer|短视频类型|是|
|8|duanshipin\_content|String|详情|是|
|9|duanshipin\_delete|Integer|逻辑删除|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|duanshipin\_id|Integer|短视频|是|
|3|yonghu\_id|Integer|用户|是|
|4|duanshipin\_collection\_types|Integer|类型|是|
...
|2|duanshipin\_id|Integer|短视频|是|
|3|yonghu\_id|Integer|用户|是|
|4|duanshipin\_liuyan\_text|String|留言内容|是|
...
|5|insert\_time|Date|添加时间|是|
|6|tuijian\_types|Integer|推荐类型|是|
|7|news\_content|String|新闻详情|是|
|8|create\_time|Date|创建时间|是|
表4.8新闻收藏表
